...
export const selectStatusStyles = {
  ...
  option: (base, state) => ({
    ...
    '&:active': { backgroundColor: standardTheme.purple, color: standardTheme.white },
  }),
  singleValue: (base) => ({ ...base, color: standardTheme.white }),
  placeholder: (base) => ({ ...base, color: standardTheme.lightGray }),
  dropdownIndicator: (base) => ({ ...base, color: standardTheme.white, '&:hover': { color: standardTheme.purple } }),
